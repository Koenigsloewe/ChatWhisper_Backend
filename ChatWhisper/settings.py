"""
Django settings for ChatWhisper project.
...
WSGI_APPLICATION = "ChatWhisper.wsgi.application"
...
SITE_NAME = 'ChatWhisper'

LLM_MODEL_ABSOLUTE_PATH = getenv('LLM_MODEL_ABSOLUTE_PATH')
